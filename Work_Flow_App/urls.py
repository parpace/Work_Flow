...
urlpatterns = [
    ...
    path('invitations/<int:pk>/', views.HandleInvitation.as_view(), name='handle_invitation'),
    ...
    path('lists/<int:pk>/tasks/', views.TaskList.as_view(), name='task_list'),
    path('tasks/', views.TaskList.as_view(), name='task_list'),
    path('tasks/<int:pk>/', views.TaskDetail.as_view(), name='task_detail'),
    path('tasks/<int:pk>/checklist-items/', views.ChecklistItemList.as_view(), name='checklist_item_list'),
